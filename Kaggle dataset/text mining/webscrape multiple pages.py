...
html_text = requests.get('https://www.mudah.my/kuala-lumpur/apartment-condominium-for-rent').text
print(html_text)
...
lists = soup.find('div', class_ ="sc-hycgNl ciVLXJ").text
print(lists)
# look through the lists and find a title for each list

price = soup.find('div', class_='sc-bNQFlB dNipmi').text
